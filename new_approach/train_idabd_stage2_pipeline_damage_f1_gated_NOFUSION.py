...
"""
================================================================================
STAGE-2 DAMAGE CLASSIFICATION (IDABD) + SUPERVISED FT (NO FUSION AUGMENTATION)
...
# =============================================================================
# Dataset (Stage-2): DESTROYED-AWARE CROPS (NO FUSION AUGMENTATION)
# =============================================================================
...
# =============================================================================
# VAL loss (for best checkpoint selection)
# =============================================================================
@torch.no_grad()
...
def train_and_eval_pipeline_one(args, init_weight: str):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if val_loss < best_val:
            ...
            print(f"[SAVE ] Best (val) -> {best_ckpt_path}")
...
def main():
    ...
    ap.add_argument("--out_dir", default="idabd_stage2_damage_ft_checkpoints_retrained_destroyed_NOFUSION")

    ap.add_argument("--min_val_destroyed_tiles", type=int, default=1)
    ap.add_argument("--min_train_destroyed_tiles", type=int, default=1)

    ap.add_argument("--loc_weight", type=str, default="", required=True)
    ap.add_argument("--loc_platt", type=str, default="")
    ap.add_argument("--loc_thresh", type=float, default=0.5)

    ap.add_argument("--csv_path", default="idabd_stage2_pipeline_results_NOFUSION.csv")
...
python train_idabd_stage2_pipeline_damage_f1_gated_NOFUSION.py --train_all --val_ratio 0.1 --test_ratio 0.1 --epochs 15 --batch 2 --lr 1e-4 --amp --use_class_weights --destroyed_weight_mul 3.0 --focus_destroyed_p 0.6 --min_destroyed_px 50 --crop_attempts 20 --calib_pixels_per_class 50000 --loc_weight idabd_stage1_loc_ft_checkpoints/dpn92_loc_0_tuned_best_idabd_ft_best.pth --loc_platt idabd_stage1_loc_ft_checkpoints/dpn92_loc_0_tuned_best_idabd_platt.npz --loc_thresh 0.5 --csv_path idabd_stage2_pipeline_results_NOFUSION.csv --overwrite_csv
"""
