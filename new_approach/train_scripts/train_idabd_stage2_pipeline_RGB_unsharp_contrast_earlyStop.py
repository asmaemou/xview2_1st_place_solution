...
"""
================================================================================
STAGE-2 DAMAGE CLASSIFICATION (IDABD) — RGB + UNSHARP + CONTRAST ONLY
...
RUNS WITH JUST:
  python train_idabd_stage2_pipeline_RGB_unsharp_contrast_only_earlyStop.py

Input (still 6-channel):
- x6 = [pre_RGB, post_RGB_used]
- post_RGB_used = post fused with:
    (A) Unsharp masking (sharpen)
    (B) Contrast enhancement (CLAHE on L channel in LAB)
...
# =============================================================================
# Fusion: Unsharp + Contrast (BGR uint8 -> BGR uint8)
# =============================================================================
...
def clahe_contrast_bgr(img_bgr: np.ndarray, clip_limit: float = 2.0, grid: int = 8) -> np.ndarray:
    """
    CLAHE on L channel in LAB. Good "contrast" boost without blowing colors.
    """
...
# =============================================================================
# Auto config utilities (same pattern as your other scripts)
# =============================================================================
