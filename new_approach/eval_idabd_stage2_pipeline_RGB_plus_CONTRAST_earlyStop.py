...
IDABD end-to-end pipeline — for outputs of:
    train_idabd_stage2_pipeline_RGB_plus_CONTRAST_only_earlyStop.py

RUNS WITH JUST:
  python eval_idabd_stage2_pipeline_RGB_plus_CONTRAST_only_earlyStop.py
================================================================================
"""
...
DEFAULT_STAGE2_DIR = "idabd_stage2_damage_ft_checkpoints_RGB+CONTRAST_ONLY"
...
def load_stage2_pack(stage2_dir: str, device, stage2_glob="*_idabd_stage2_ft_best.pth", stage2_max_models: int = 12):
    ...
    for ck in ckpts:
        ...
        if not calib:
            raise FileNotFoundError(f"Missing calibration for stage2 ckpt:\n  ckpt={ck}\n  dir={stage2_dir}")
...
def main():
    ...
    ap.add_argument("--csv_path", default="idabd_pipeline_ENSEMBLE_LOC+DMG_CAL_ONLY_RGB+CONTRAST_ONLY.csv")
