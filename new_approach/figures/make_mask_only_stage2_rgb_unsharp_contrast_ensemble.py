...
"""
ZERO-ARGS:
    python make_mask_only_stage2_rgb_unsharp_contrast_ensemble.py

Outputs (NO caption, NO borders):
  - mask_only_RGB_UNSHARP_CONTRAST_ONLY.png
  - overlay_only_RGB_UNSHARP_CONTRAST_ONLY.png   (optional)
...
Folder used:
  idabd_stage2_damage_ft_checkpoints_RGB_UNSHARP_CONTRAST_ONLY
"""
...
STAGE2_DIR_REL  = r"idabd_stage2_damage_ft_checkpoints_RGB_UNSHARP_CONTRAST_ONLY"
...
OUT_MASK_ONLY    = "mask_only_RGB_UNSHARP_CONTRAST_ONLY.png"
OUT_OVERLAY_ONLY = "overlay_only_RGB_UNSHARP_CONTRAST_ONLY.png"
# =========================
