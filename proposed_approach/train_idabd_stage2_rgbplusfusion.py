...
def main():
    ...
    # dataset: TRAIN = fusion on post with prob fusion_p ; VAL/TEST = raw post
    train_ds = IdaBDStage2Dataset6CH(
        ...
        post_transform_train=fusion_augment,
    ...
    row = {
        "seed": args.seed, "init_weight": args.init_weight, "loc_weight": args.loc_weight,
        "loc_platt": args.loc_platt, "loc_thresh": args.loc_thresh,

        "pipeline_acc_uncal": acc_u, "pipeline_loc_precision_uncal": locP_u, "pipeline_loc_recall_uncal": locR_u,
        "pipeline_loc_f1_uncal": locF_u, "pipeline_macroF1_damage_uncal": macro_u,
        ...
        "pipeline_acc_cal": acc_c, "pipeline_loc_precision_cal": locP_c, "pipeline_loc_recall_cal": locR_c,
        "pipeline_loc_f1_cal": locF_c, "pipeline_macroF1_damage_cal": macro_c,
