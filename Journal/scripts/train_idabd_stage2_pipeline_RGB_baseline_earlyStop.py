...
# ---------------------------------------------------------------------
DATA_ROOT = "/homes/j244s673/documents/wsu/phd/idabd/PRJ-5770/Project--ian-bd-pre-and-post-disaster-high-resolution-aerial-imagery-for-building-damage-assessment-from-hurricane-ian/data"

IMG_DIR = f"{DATA_ROOT}/images"
MASK_DIR = f"{DATA_ROOT}/masks"

# Stage-2 damage-classification initialization weights
WEIGHTS_DIR = "/homes/j244s673/documents/wsu/phd/xview2_1st_place_solution/new_approach/weights"

# Stage-2 fine-tuned checkpoints
OUT_DIR = "/homes/j244s673/documents/wsu/phd/xview2_1st_place_solution/Journal/outputs/idabd_stage2_damage_ft_checkpoints_RGB_baseline_earlyStop"

# CSV results
CSV_PATH = "/homes/j244s673/documents/wsu/phd/xview2_1st_place_solution/Journal/results/idabd_stage2_pipeline_RGB_baseline_earlyStop.csv"
